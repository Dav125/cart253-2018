...
// Used the keyPressed function
// to call upon the shootFruit function
// it allows the fruit to be shot seperately
Cannon.prototype.keyPressed = function() {
  if (keyCode === 32) {
    this.shootFruit();
    shot.play();
    shot.currentTime = 0;
...
// upon, it shoots different fruit
Cannon.prototype.shootFruit = function() {
